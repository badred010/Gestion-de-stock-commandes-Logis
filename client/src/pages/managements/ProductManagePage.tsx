...
const SellProductModal = ({ product }: { product: IProduct & { key: string } }) => {
  ...
  return (
    <>
      ...
      <Modal title='Nouvelle Vente' open={isModalOpen} onCancel={handleCancel} footer={null}>
...
const AddStockModal = ({ product }: { product: IProduct & { key: string } }) => {
  ...
  return (
    <>
      ...
      <Modal title='Ajouter Produits au stock' open={isModalOpen} onCancel={handleCancel} footer={null}>
        <form onSubmit={handleSubmit(onSubmit)} style={{ margin: '2rem' }}>
          <CustomInput name='stock' label='ajouter stock' register={register} type='number' />
          <Flex justify='center' style={{ marginTop: '1rem' }}>
            <Button htmlType='submit' type='primary'>
              Valider
            </Button>
...
const UpdateProductModal = ({ product }: { product: IProduct & { key: string } }) => {
  ...
  return (
    <>
      ...
      <Modal title='Mise à jour Produit' open={isModalOpen} onCancel={handleCancel} footer={null}>
...
const DeleteProductModal = ({ id }: { id: string }) => {
  ...
  return (
    <>
      ...
      <Modal title='Supprimer Produit' open={isModalOpen} onCancel={handleCancel} footer={null}>
        <div style={{ textAlign: 'center', padding: '2rem' }}>
          <h2>Etes-vous sure?</h2>
          <div
