  ...
  if (isLoading && isLoading1) return <Loader />;
    ...
    return (
      <>
        ...
        >
          <h1 style={{ textAlign: 'center', marginBottom: '.5rem' }}>Ventes quotidiennes et revenu</h1>
          <DailyChart />
        </div>
        <div
          style={{
        ...
        >
          <h1 style={{ textAlign: 'center', marginBottom: '.5rem' }}>Revenu mensuel</h1>
          <MonthlyChart />
        </div>
        <div
          style={{
        ...
        >
          <h1 style={{ textAlign: 'center', marginBottom: '.5rem' }}>Historique de ventes</h1>
          <SaleHistoryPage />
        </div>
      </>
    );
